...
if ($players >0) {
					// we have players
					// add sub template
					$disp .= '<table style="width:100%;"><tr><td style="width:30%;">Name</td><td  align="center"style="width:30%;">Country</td><td style="width:20%;">Score</td><td>Time Online</td></tr>'; // start table
