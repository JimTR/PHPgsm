...
if ($players >0) {
					// we have players
					// add sub template
					$disp .= '<table style="width:100%;"><tr class="country"><td style="width:40%;">Name</td><td style="width:30%;">Country</td><td style="width:10%;">Score</td><td>Time Online</td></tr>'; // start table
