<?PHP
    ...
    class Config
    {
        ...
        private $productionServers = array('/^localhost$/');
        ...
        // ...For Auth Class
        public $authDomain = "http://localhost";         // Domain to set for the cookie
        ...
        private function __construct()
        {
            ...
            elseif('shell' == $i_am_here)
                ...
                die('<h1>Where am I?</h1> <p>You need to setup your server names in <code>class.config.php</code></p>
                     <p><code>$_SERVER[\'HTTP_HOST\']</code> reported <code>' . $_SERVER['HTTP_HOST'] . '</code></p>'. "i am here = ".$i_am_here);
        }
        ...
        private function production()
        {
            ...
            define('WEB_ROOT', 'localhost/fw');

            $this->dbReadHost      = 'localhost';
            $this->dbWriteHost     = 'localhost';
            $this->dbName          = 'yoursite';
            $this->dbReadUsername  = '1612';
            $this->dbWriteUsername = '1612';
            $this->dbReadPassword  = 'mybb1612';
            $this->dbWritePassword = 'mybb1612';
            $this->dbOnError       = '';
