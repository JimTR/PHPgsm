...
$Query->Disconnect( );
//print_r($rules);
echo '<table style="width:95%;table-layout: fixed;"><tr><th style="width:65%;position: -webkit-sticky;position: sticky; top: 0; z-index: 2;">Rule</th>
